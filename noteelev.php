    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <?php
                ...
                $sql = "SELECT elev_id_elev, materie, nota
                from mydb.note
                inner join mydb.elev on elev_id_elev = id_elev WHERE elev_id_elev='{$_GET['id']}'";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                  echo "<table><tr><th>ID</th><th>Materie</th><th>Nota</th></tr>";
                  // output data of each row
                  while($row = $result->fetch_assoc()) {
                    echo "<tr><td>".$row["elev_id_elev"]."</td><td>".$row["materie"]."</td><td>".$row["nota"]."</td></tr>";     
                  }
