...
from mydb.elev ORDER BY nume ASC LIMIT ?,?')) {
			...
			<table>
				...
				<tr> 
					...
					<td><?php echo $row['cnp']; ?></td>
                                        ...
                                        <td ><?php echo "<a href=\"editeaza_elev.php?id=".$row['id_elev']."\"><img src='images/edit-sign.png' alt='HTML tutorial' style='width:20px;height:20px;'></a> <a onClick=\"javascript: return confirm('Esti sigur ca vrei sa stergi acest elev?');\" href=\"delete.php?id=".$row['id_elev']."\"><img src='images/delete-sign.png' alt='HTML tutorial' style='width:20px;height:20px;'></a>"?>  </td>
				</tr>
				<?php endwhile; ?>
			</table>
