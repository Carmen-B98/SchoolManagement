...
<?php
     ...
     include 'showDB.php';
    $sql = "select distinct  id_elev,nume, prenume, clasa_nume_clasa, avg(nota)
from mydb.elev
...
LIMIT 3
;";
$result = $conn->query($sql);  //returns the second argument passed into the function
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Elevi cu rezultate excelente</h4>
                    </div>
