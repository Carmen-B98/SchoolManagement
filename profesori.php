...
$sql = "SELECT id_profesor, nume_profesor, prenume_profesor, cnp,  data_nastere, email, nr_telefon, nivel_invatamant, functie, studii, grad_didactic, vechime, nume_clasa
FROM mydb.profesor
inner join mydb.clasa on id_profesor=profesor_id_profesor order by nume_profesor asc";
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Lista profesorilor</h4>
                    </div>
			...
			<table>
				...
				<tr>
					<td><?php echo $row['nume_profesor']; ?></td>
					<td><?php echo $row['prenume_profesor']; ?></td>
					<td><?php echo $row['cnp']; ?></td>
                                        <td><?php echo $row['data_nastere']; ?></td>
                                        <td><?php echo $row['email']; ?></td>
                                        <td><?php echo $row['nr_telefon']; ?></td>
                                        <td><?php echo $row['nivel_invatamant']; ?></td>
                                        <td><?php echo $row['functie']; ?></td>
                                        <td><?php echo $row['studii']; ?></td>
                                        <td><?php echo $row['grad_didactic']; ?></td>
                                        <td><?php echo $row['vechime']; ?></td>
                                        <td><?php echo $row['nume_clasa']; ?> </td>
				</tr>
				<?php endwhile; ?>
			</table>
			       </div>
